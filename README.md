...
Another alternative to using an http server as the middle man would be to use the Network Framework which is very compact and easy to use. You may be able to do with only an XPC Service or two.
```shell
