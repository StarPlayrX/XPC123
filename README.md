...
The MachService seems to only works from a command line app / headless app, and not as a plugin. This means it needs to run as a LaunchDaemon which will make it system wide.
