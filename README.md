...
Example LaunchDaemon values. The plist is included in the repo. Edit it to your liking and place it in /Librrary/LaunchDaemons and fix its permissions (see below). 
